from scipy.integrate import odeint  # 导入 scipy.integrate 横块
...
s0 = 1-i0  # 易感者比例的初值
Y0 = (i0, s0)  # 微分方程组的初值
print("lamda=(\tmu= \tsigma=t(1-1/sig)={}".format(lamda, mu, sigma, fsig))
